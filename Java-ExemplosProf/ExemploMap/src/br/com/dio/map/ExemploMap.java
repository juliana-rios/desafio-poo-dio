...
//        Map<String, Double> carrosPopulares2020 = Map.of("gol", 14.4, "uno", 15.6, "mobi", 16.1, "hb20", 14.5, "kwid", 15.6)
        ...
        System.out.println("Crie um dicionario que relacione os modelo e seus respectivos consumos: ");
       ...
       // System.out.println("\nExiba o terceiro modelo adicionado: ");
        ...
        System.out.println("\nApague dicionário carros: ");
        carrosPopulares.clear();

        System.out.println("\nConfira se dicionário está vazio: " + carrosPopulares.isEmpty());
    }
}
